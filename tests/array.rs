...
mod tests {
    ...
    fn test_swap_all_initialized() {
        ...
        let result = swap_maybeuninit_to_option(arr, 5);
    ...
    fn test_swap_partial_initialized() {
        ...
        let result = swap_maybeuninit_to_option(arr, 3);
    ...
    fn test_swap_single_element() {
        ...
        let result = swap_maybeuninit_to_option(arr, 1);
    ...
    fn test_swap_no_elements() {
        ...
        let result = swap_maybeuninit_to_option(arr, 0);
